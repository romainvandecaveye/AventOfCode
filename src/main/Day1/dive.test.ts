...
describe('dive with array', () => {
  it('should return 900 when it is forward 1 from example array ', () => {
    ...
    let actual = day2.diveFromArray(exempleArray).multiply();
